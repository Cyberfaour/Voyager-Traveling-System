...
namespace Voyager.Controllers
{
    ...
    public class PostsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,PostName,PostDescription,TimeStamp")] Post post)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,PostName,PostDescription,TimeStamp")] Post post)
        {
            if (id != post.Id)
            {
                return NotFound();
